...
$api = new OTruyenAPI();
$list_data = $api->getComicList('dang-phat-hanh', $page, $per_page);
$comics = [];
$total_comics = 0;
$total_pages = 1;
...
<head>
    ...
    <title>TruyenGG - Truyện Đang Phát Hành</title>
    ...
    <div class="container container-background">
        <section>
            <div class="d-flex mb15">
                <h1 class="title_cate mr-auto"><i class="bi bi-cloud-arrow-down-fill"></i> Truyện Đang Phát Hành</h1>
            </div>
            <div class="row list_item_home">
                <?php if (!empty($comics)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>Chưa có truyện nào đang phát hành.</p>
                <?php endif; ?>
            </div>
            <div class="pagination mt-4 mb20">
                ...
                if ($page > 1) {
                    echo '<a class="page-item" href="' . $base_url . 'truyen-moi-cap-nhat.php?page=1"><span aria-hidden="true">«</span></a>';
                    echo '<a class="page-item" href="' . $base_url . 'truyen-moi-cap-nhat.php?page=' . ($page - 1) . '"><span aria-hidden="true">‹</span></a>';
                }

                for ($i = $start_page; $i <= $end_page; $i++) {
                    echo '<a href="' . $base_url . 'truyen-moi-cap-nhat.php?page=' . $i . '" 
                           class="page-item ' . ($page === $i ? 'active' : '') . '">' . $i . '</a>';
                }

                if ($page < $total_pages) {
                    echo '<a class="page-item" href="' . $base_url . 'truyen-moi-cap-nhat.php?page=' . ($page + 1) . '"><span aria-hidden="true">›</span></a>';
                    echo '<a class="page-item" href="' . $base_url . 'truyen-moi-cap-nhat.php?page=' . $total_pages . '"><span aria-hidden="true">»</span></a>';
                }
                ?>
            </div>
        </section>
