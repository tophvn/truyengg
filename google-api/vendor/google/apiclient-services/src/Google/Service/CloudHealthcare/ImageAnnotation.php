...
class Google_Service_CloudHealthcare_ImageAnnotation extends Google_Collection
{
  protected $collection_key = 'boundingPolys';
  protected $boundingPolysType = 'Google_Service_CloudHealthcare_BoundingPoly';
  protected $boundingPolysDataType = 'array';

  /**
   * @param Google_Service_CloudHealthcare_BoundingPoly
   */
