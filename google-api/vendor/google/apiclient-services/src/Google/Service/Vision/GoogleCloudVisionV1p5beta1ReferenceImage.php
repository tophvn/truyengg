...
class Google_Service_Vision_GoogleCloudVisionV1p5beta1ReferenceImage extends Google_Collection
{
  protected $collection_key = 'boundingPolys';
  protected $boundingPolysType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1BoundingPoly';
