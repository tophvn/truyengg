...
class Google_Service_Vision_GoogleCloudVisionV1p5beta1ProductSearchResults extends Google_Collection
{
  protected $collection_key = 'results';
  public $indexTime;
  protected $productGroupedResultsType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1ProductSearchResultsGroupedResult';
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1p5beta1ProductSearchResultsGroupedResult
   */
