...
class Google_Service_Vision_GoogleCloudVisionV1p5beta1FaceAnnotation extends Google_Collection
{
  ...
  protected $fdBoundingPolyType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1BoundingPoly';
  protected $fdBoundingPolyDataType = '';
  public $headwearLikelihood;
  public $joyLikelihood;
  public $landmarkingConfidence;
  protected $landmarksType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1FaceAnnotationLandmark';
   ...
   * @param Google_Service_Vision_GoogleCloudVisionV1p5beta1BoundingPoly
   */
  public function setFdBoundingPoly(Google_Service_Vision_GoogleCloudVisionV1p5beta1BoundingPoly $fdBoundingPoly)
  {
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1p5beta1FaceAnnotationLandmark
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1p5beta1FaceAnnotationLandmark
   */
