...
class Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetection extends Google_Collection
{
  protected $collection_key = 'webEntities';
  protected $bestGuessLabelsType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebLabel';
  protected $bestGuessLabelsDataType = 'array';
  protected $fullMatchingImagesType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebImage';
  protected $fullMatchingImagesDataType = 'array';
  protected $pagesWithMatchingImagesType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebPage';
  protected $pagesWithMatchingImagesDataType = 'array';
  protected $partialMatchingImagesType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebImage';
  protected $partialMatchingImagesDataType = 'array';
  protected $visuallySimilarImagesType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebImage';
  protected $visuallySimilarImagesDataType = 'array';
  protected $webEntitiesType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebEntity';
  protected $webEntitiesDataType = 'array';

  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebLabel
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebLabel
   */
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebPage
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebPage
   */
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebEntity
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1p5beta1WebDetectionWebEntity
   */
