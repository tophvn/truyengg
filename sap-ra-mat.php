...
$api = new OTruyenAPI();
$list_data = $api->getComicList('sap-ra-mat', $page, $per_page);
$comics = [];
$total_comics = 0;
$total_pages = 1;
...
<head>
    ...
    <title>TruyenGG - Truyện Sắp Ra Mắt</title>
    <meta name="description" content="<?php echo htmlspecialchars($list_data['data']['seoOnPage']['descriptionHead'] ?? 'Danh sách truyện tranh sắp ra mắt.'); ?>">
    ...
    <div class="container container-background">
        <section>
            <div class="d-flex mb15">
                <h1 class="title_cate mr-auto"><i class="bi bi-cloud-arrow-down-fill"></i> Truyện Sắp Ra Mắt</h1>
            </div>
            <div class="row list_item_home">
                <?php if (!empty($comics)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>Chưa có truyện sắp ra mắt nào.</p>
                <?php endif; ?>
            </div>
            <div class="pagination mt-4 mb20">
                ...
                if ($page > 1) {
                    echo '<a class="page-item" href="' . $base_url . 'sap-ra-mat.php?page=1"><span aria-hidden="true">«</span></a>';
                    echo '<a class="page-item" href="' . $base_url . 'sap-ra-mat.php?page=' . ($page - 1) . '"><span aria-hidden="true">‹</span></a>';
                }

                for ($i = $start_page; $i <= $end_page; $i++) {
                    echo '<a href="' . $base_url . 'sap-ra-mat.php?page=' . $i . '" 
                           class="page-item ' . ($page === $i ? 'active' : '') . '">' . $i . '</a>';
                }

                if ($page < $total_pages) {
                    echo '<a class="page-item" href="' . $base_url . 'sap-ra-mat.php?page=' . ($page + 1) . '"><span aria-hidden="true">›</span></a>';
                    echo '<a class="page-item" href="' . $base_url . 'sap-ra-mat.php?page=' . $total_pages . '"><span aria-hidden="true">»</span></a>';
                }
                ?>
            </div>
        </section>
